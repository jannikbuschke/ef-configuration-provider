...
declare module "react-router-dom" {
  ...
  export namespace H {
    ...
    export type LocationListener<S = LocationState> = History.LocationListener<
      S
    >
  ...
  export interface RouteProps {
    ...
    children?: // | ((props: RouteChildrenProps<any>) => React.ReactNode) // SWYX: i think this is not needed anymore?
